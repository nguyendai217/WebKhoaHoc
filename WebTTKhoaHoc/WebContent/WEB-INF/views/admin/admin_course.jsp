        ...
        <div class="sidebar" data-background-color="white" data-active-color="danger">
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    ...
                    <li>
                        <a href="ClassAdmin"> <i class="ti-view-list-alt"></i>
                            <p>Quản lí lớp học</p>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="NewsAdmin"> <i class="ti-write"></i>
                            <p>Quản lí tin tức</p>
                        </a>
                    </li>
                    <li class="active-pro">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse">
                        <ul class="nav navbar-nav navbar-right">
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img src="${adminAvatar}" class="img_avatar img-responsive" alt="" />
                                    <p>&nbsp;${adminName}&nbsp;</p>
                                </a>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <form action="DeleteCourse" id="form1" method="post" onsubmit="return checkCheckBoxesCourse(this)">
                                                        ...
                                                        <td>
                                                            <div>
                                                                <span class="avatar"> <img
																	src="${listCourse.courseimage}" height="60"
																	width="90">
																</span>
                                                            </div>
                                                        </td>
                                                        <td>${listCourse.description}</td>
                                                        <td><fmt:formatNumber type="number" maxIntegerDigits="10" value="${listCourse.fee}" /> VND</td>
                                                        <td>
                                                            <a href="viewCourseInfo?courseID=${listCourse.course_id}" style="font-size: 16px; color: black; padding-left: 30px;" class="ti-pencil-alt"></a>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
