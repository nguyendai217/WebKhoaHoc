...
<div class="wrapper">
    ...
    <div class="main-panel">
                                 ...
                                 <form action="UpdateCourse" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control border-input" name="coursename" value="${courseInfo.coursename}" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                            	<input type="hidden" id="Topic" value="${courseInfo.topic_id}" />
                                                <label>Chủ đề</label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                	<input type="number" class="form-control border-input" name="fee" value="${courseInfo.fee}" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Mô tả</label>
                                                <textarea rows="2" class="form-control border-input" name="description" placeholder="Description">${courseInfo.description}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="7" class="form-control border-input" name="info" placeholder="Detailed infomation">${courseInfo.info}</textarea>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="changeImage" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="padding-top: 100px;">
            <form id="imageHotel" action="UploadImageCourse?IDupload=${courseInfo.course_id}" method="post" enctype="multipart/form-data">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Thay ảnh khóa học</h4>
                        </div>
...
(function () {
    ...
    for(var i=0; i < 3; i++)
    {
      if(document.getElementById('listTopic').options[i].value == k) {
        document.getElementById('listTopic').selectedIndex = i;
        return;
      }
    }  
